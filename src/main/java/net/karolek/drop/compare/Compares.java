...
public class Compares {
    ...
    public static Compare<Integer> parseString(String string) {
        ...
        {
            Matcher lessThanM = GREATER_THAN_PATTERN.matcher(string);
            if (lessThanM.find()) {
                int value = Integer.parseInt(lessThanM.group(1));
        ...
        {
            Matcher lessThanM = BETWEEN_PATTERN.matcher(string);
            if (lessThanM.find()) {
                int value1 = Integer.parseInt(lessThanM.group(1));
                int value2 = Integer.parseInt(lessThanM.group(2));
